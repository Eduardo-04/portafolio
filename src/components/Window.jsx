...
const Window = ({ title, children, onClose, onMinimize, id, width = '900px' }) => { // Añadimos width por defecto
  ...
  return (
    <div 
      ...
      // CAMBIO AQUÍ: Usamos la prop width y aumentamos el maxHeight para la galería
      style={{ left: pos.x, top: pos.y, width: width, zIndex: isDragging ? 100 : 10, maxHeight: '90vh' }}
    >
      ...
      <div className="p-[2px] bg-[#ece9d8] flex flex-col overflow-hidden">
        <div 
          ...
          style={{ height: 'auto', maxHeight: '750px' }} // Aumentamos maxHeight para fotos grandes
        >
          {children}
        </div>
      </div>
